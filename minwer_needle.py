...
def MinWER(ref, hyp, metric, threshold, save, memory):
    ...
    errors, distance = align.awer(ref, hyp)
...
if __name__ == '__main__':
    ...
    # for threshold in [0.004, 0.024, 0.4]:
    
    #for threshold in numpy.arange(0.004, 0.1, 0.005):
    for threshold in numpy.arange(0.105, 0.12, 0.005):
